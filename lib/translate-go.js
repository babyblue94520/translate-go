 ...
 * @param text
 */
TranslateDB.prototype.getTranslateSourceAndLogByKey = function getTranslateSourceAndLogByKey (key) {
 ...
 * @param word
 */
TranslateDB.prototype.getWordSource = function getWordSource (word) {
 ...
 * @param word
 */
TranslateDB.prototype.getWordRegex = function getWordRegex (word) {

 ...
 * @param node
 */
TranslateUtil.cleanFilter = function cleanFilter (node) {
 ...
 * @param text
 */
TranslateNodes.prototype.buildText = function buildText (key, text) {
...
var TranslateGO = function TranslateGO() {
    ...
    this.domSubtreeModified = function (e) {
        ...
        if (this$1.translateTexts.need(node)) {
            ...
            setTimeout(this$1.cleanTextNodes, this$1.delay);
        }
    };
    /**
     * 載入需要翻譯的Node
    ...
    this.setInnerTexts = function () {
        this$1.removeEvents();
        this$1.notSetInnerTexts = true;
        var element, key;
        for (var i = 0, l = this$1.innerTexts.length; i < l; i++) {
            element = this$1.innerTexts[i].element;
            key = this$1.innerTexts[i].key;
            if (element.innerText == '') {
                element.appendChild(this$1.translateTexts.buildText(key, ''));
            }
        }
        this$1.innerTexts.length = 0;
        this$1.addEvents();
    };
};
/**
 ...
 * 監聽 Element 新增跟異動事件
 */
TranslateGO.prototype.addEvents = function addEvents () {
 ...
 * 移除 Element 新增跟異動事件
 */
TranslateGO.prototype.removeEvents = function removeEvents () {
